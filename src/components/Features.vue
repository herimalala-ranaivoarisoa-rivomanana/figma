<template>
  <section class="w-full h-1362px m-auto flex flex-col items-center mb-80">
    <div class="m-auto mb-20 center w-214px h-75px">
    ...
    <div class="m-auto center flex 
                sm:flex sm:w-full sm:flex-col sm:items-center">
